...
## Сценарий   
 ...
 |5. Клонировать репозиторий на локальный компьютер|git clone https://github.com/OlgaVyunik/JSON.git |git clone https://github.com/OlgaVyunik/XML.git|git clone https://github.com/OlgaVyunik/TXT.git|
